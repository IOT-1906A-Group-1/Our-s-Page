    ...
    <a-skeleton :loading="loading" active :paragraph="paragraph">
        <div class="wLevel_1_Div">
            <img
                class="icon"
                :src="Icon"
                style="width: 40px; position: relative; bottom: 12px"
            />
            <label class="wLevel_1_Label"
                >你好，{{ firstName + lastName }}</label
            ><br />
            <div style="width: 880px; height: 120px">
                ...
                >
                    <label
                        ...
                        >已处理申请</label
                    ><br />
                    <label style="font-size: 33px; font-weight: 500"
                        >1,653</label
                    >
                </div>
                <div
        ...
        <div style="width: 880px; height: 600px; float: left">
